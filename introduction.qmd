...
**Condition (English)**
- **Meaning**
  - A type of state, a state that needs/is required to be true/valid in order for a thing/object of primary interest to be (to be true/valid)
- **Linguistic/dialectic parent**
  - Inherited from old French condicion (requisite/prerequisite/stipulation) which is derived from Latin condicio (agreement) which is derived from Latin condicere (agree upon)
...
- **Linguistic/dialectic parent** 
  - Inherited from Latin lemma (meaning something assumed), which is inherited from Greek lemma (meaning something assumed), derived from the root Latin lambanein (meaning to take) and root Greek lambano (meaning "I take")
...
- **Linguistic/dialectic parent**
  - Inherited from Latin corollarium (meaning money paid for a garland or chaplet; gratuity) and Late Latin corollarium (meaning deduction), inherited Latin corolla/corona (meaning wreath, crown, chaplet) (Google)
- **Mathematics**
